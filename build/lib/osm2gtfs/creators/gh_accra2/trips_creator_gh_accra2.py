...
#Could add: 1) some kind of string matching value threshold (what if stops are missing from stop list and not just a naming issue for the first/last stops....)
#2) Could add a counter of how many items were changed
